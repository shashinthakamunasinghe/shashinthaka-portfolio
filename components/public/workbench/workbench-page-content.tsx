...
const wipItems = [
  {
    ...
    description: "Containerized campus event management platform — Spring Boot, JWT auth, RBAC, Docker, Azure Container Apps",
    progress: 80,
  ...
  {
    id: 2,
    name: "CampusAura-frontend",
    description: "React 19 frontend for CampusAura with responsive dashboards and Firebase integration",
    progress: 75,
    lastUpdated: "Dec 2025",
    url: "https://github.com/sandaluruba/CampusAura-frontend",
    branch: "main",
    commits: 48,
  },
  {
    id: 3,
    name: "happy-tails-uwu-api",
    description: "Spring Boot REST API for animal welfare — stray reporting, adoption management, vet clinic directory",
    progress: 65,
...
const recentActivity = [
  { type: "commit", project: "CampusAura-backend", message: "Add Azure Container Apps deployment config", time: "1 day ago" },
  { type: "branch", project: "CampusAura-frontend", message: "Created feature/dashboard-redesign branch", time: "2 days ago" },
  { type: "commit", project: "happy-tails-uwu-api", message: "Implement adoption management endpoints", time: "3 days ago" },
  { type: "commit", project: "CampusAura-backend", message: "Integrate Firebase JWT authentication", time: "5 days ago" },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/shashinthakamunasinghe/active</span>
